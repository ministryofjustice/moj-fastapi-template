...
- An included Dockerfile and Docker Compose
- Example Helm charts and a CI/CD Pipleline for deploying to the MOJ's [Cloud Platform](https://user-guide.cloud-platform.service.justice.gov.uk/).
