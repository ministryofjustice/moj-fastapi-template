...
- A [FastAPI](https://fastapi.tiangolo.com/) REST API with CRUD operations, including autogenerated [Swagger](https://swagger.io/) docs.
...
- Example Helm charts and a CI/CD Pipeline for deploying to the MOJ's [Cloud Platform](https://user-guide.cloud-platform.service.justice.gov.uk/).
...
Documentation about how to build on this skeleton can be found here:
