...
async def update_case(case_id: UUID, case_update: Case, session: Session = Depends(get_session)):
...
async def change_category(case_id: UUID, category: Category, session: Session = Depends(get_session)):
...
async def delete_case(case_id: UUID, session: Session = Depends(get_session), current_user: User = Depends(get_current_active_user)):
